...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 08 août 2023 à 14:54
...
--
-- Structure de la table `admin_credentials`
--
...
--
-- Déchargement des données de la table `admin_credentials`
--
...
--
-- Structure de la table `medicines_stock`
--
...
--
-- Déchargement des données de la table `medicines_stock`
--
...
--
-- Index pour la table `admin_credentials`
--
...
--
-- Index pour la table `medicines_stock`
--
...
--
-- AUTO_INCREMENT pour la table `medicines_stock`
--
ALTER TABLE `medicines_stock`
